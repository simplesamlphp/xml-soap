...
use SimpleSAML\SOAP\Type\MustUnderstandValue;
use SimpleSAML\Test\SOAP\Assert\MustUnderstandTest;
use SimpleSAML\XMLSchema\Exception\SchemaViolationException;

/**
 * Class \SimpleSAML\Test\SOAP\Type\MustUnderstandValueTest
 *
...
final class MustUnderstandValueTest extends TestCase
{
    ...
    public function testHelpers(): void
    {
        ...
        $this->assertEquals($attr->getNamespaceURI(), C::NS_SOAP_ENV_11);
